...
sx q[72];
rz(1.6369627429575306) q[72];
sx q[80];
rz(0.8397366260192594) q[80];
sx q[80];
rz(-1.8971269718342274) q[80];
sx q[81];
rz(1.704757879308132) q[81];
sx q[81];
rz(-0.009380718364164764) q[81];
sx q[82];
rz(-3.0112043102794672) q[82];
sx q[82];
rz(-1.7291536732871142) q[82];
cx q[81],q[82];
cx q[81],q[80];
cx q[81],q[72];
sx q[81];
...
cx q[81],q[72];
sx q[72];
rz(2.8487544111850127) q[72];
sx q[72];
rz(0.7070221297771191) q[72];
sx q[81];
rz(1.1646500873100196) q[81];
sx q[81];
rz(1.964255432968912) q[81];
cx q[82],q[81];
cx q[80],q[81];
cx q[72],q[81];
cx q[81],q[72];
...
sx q[82];
rz(0.9449733637530091) q[82];
barrier q[82],q[72],q[80],q[81];
measure q[82] -> meas[0];
measure q[72] -> meas[1];
measure q[80] -> meas[2];
measure q[81] -> meas[3];
