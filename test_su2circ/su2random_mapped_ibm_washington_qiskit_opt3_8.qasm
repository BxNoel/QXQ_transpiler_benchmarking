...
creg meas[8];
sx q[28];
rz(1.563280899135842) q[28];
sx q[28];
rz(2.8487544111850127) q[28];
sx q[35];
rz(-3.0112043102794672) q[35];
sx q[35];
rz(-2.5865372311326773) q[35];
sx q[44];
rz(1.6369627429575306) q[44];
sx q[44];
rz(0.7070221297771191) q[44];
rz(0.4529801211943343) q[45];
sx q[45];
rz(-1.7465700745534285) q[45];
sx q[45];
sx q[46];
rz(0.8397366260192594) q[46];
sx q[46];
...
sx q[48];
rz(-3.1167849646094155) q[48];
cx q[47],q[48];
cx q[46],q[47];
cx q[47],q[46];
cx q[46],q[47];
cx q[35],q[47];
rz(-1.4760003191610123) q[46];
sx q[46];
cx q[45],q[46];
sx q[45];
rz(-pi/2) q[45];
...
rz(-pi/2) q[45];
sx q[45];
rz(-0.09479600763388518) q[45];
sx q[46];
rz(1.1238974498414667) q[46];
sx q[46];
rz(pi/2) q[46];
cx q[47],q[35];
cx q[35],q[47];
...
sx q[54];
rz(1.964255432968912) q[54];
cx q[45],q[54];
cx q[45],q[44];
sx q[45];
rz(1.3933297522764274) q[45];
sx q[45];
rz(-0.36547294383071005) q[45];
cx q[46],q[45];
cx q[45],q[46];
cx q[46],q[45];
cx q[45],q[54];
...
cx q[47],q[46];
sx q[47];
rz(0.2673141479915979) q[47];
sx q[47];
rz(0.9449733637530091) q[47];
cx q[48],q[47];
cx q[46],q[47];
cx q[47],q[46];
cx q[46],q[47];
...
sx q[28];
rz(0.6348464674842358) q[28];
sx q[35];
rz(1.0941137716709264) q[35];
sx q[35];
rz(0.13601306986195993) q[35];
cx q[28],q[35];
cx q[35],q[28];
cx q[28],q[35];
sx q[47];
...
cx q[46],q[47];
sx q[46];
rz(-2.5732197993538017) q[46];
sx q[46];
rz(-1.891568395380352) q[46];
cx q[47],q[46];
cx q[46],q[47];
cx q[47],q[46];
cx q[48],q[47];
...
sx q[48];
rz(2.0490902607683257) q[48];
rz(1.0368254640000032) q[54];
sx q[54];
rz(-0.2745466276846109) q[54];
barrier q[44],q[54],q[48],q[28],q[45],q[35],q[46],q[47];
measure q[44] -> meas[0];
measure q[54] -> meas[1];
measure q[48] -> meas[2];
measure q[28] -> meas[3];
