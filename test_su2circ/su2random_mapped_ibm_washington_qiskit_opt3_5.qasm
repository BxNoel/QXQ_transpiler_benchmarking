...
sx q[84];
rz(-2.0790379300152226) q[84];
sx q[85];
rz(1.704757879308131) q[85];
sx q[85];
rz(-1.7291536732871142) q[85];
cx q[85],q[73];
sx q[86];
rz(0.8397366260192594) q[86];
sx q[86];
rz(1.6369627429575306) q[86];
cx q[85],q[86];
cx q[85],q[84];
cx q[73],q[85];
cx q[85],q[73];
...
rz(pi/2) q[85];
cx q[84],q[85];
rz(1.1773372206208812) q[84];
sx q[84];
rz(-1.793373244068876) q[84];
rz(1.569202385418838) q[85];
sx q[85];
rz(-1.647386025092052) q[85];
sx q[85];
rz(-0.49581162675767043) q[85];
cx q[86],q[85];
cx q[85],q[73];
cx q[73],q[85];
cx q[73],q[66];
cx q[66],q[73];
rz(-1.3581059974401182) q[66];
sx q[66];
rz(pi/2) q[66];
rz(-0.15662994627784643) q[73];
sx q[73];
rz(-pi/2) q[73];
cx q[84],q[85];
cx q[85],q[84];
...
sx q[66];
rz(-2.5067461861055573) q[66];
rz(2.655557456797502) q[73];
sx q[73];
rz(-1.7594721966576232) q[73];
sx q[73];
rz(2.6145355444465954) q[73];
rz(1.7623029258205802) q[85];
sx q[85];
rz(-0.6925899583078419) q[85];
sx q[85];
rz(0.9867443340330313) q[85];
sx q[86];
rz(0.2673141479915979) q[86];
sx q[86];
rz(-0.414602307567705) q[86];
cx q[86],q[85];
cx q[84],q[85];
cx q[85],q[84];
cx q[86],q[85];
...
sx q[85];
rz(-1.1357731497354902) q[85];
sx q[85];
rz(-2.846934388642458) q[85];
sx q[86];
rz(1.9177739057498941) q[86];
sx q[86];
rz(-1.2522384758651306) q[86];
