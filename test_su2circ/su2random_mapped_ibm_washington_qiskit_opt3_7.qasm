...
sx q[54];
rz(0.07660625016677436) q[54];
sx q[63];
rz(-1.7291536732871133) q[63];
sx q[63];
rz(-3.11678496460941) q[63];
sx q[64];
rz(0.8397366260192594) q[64];
sx q[64];
...
rz(pi/2) q[65];
cx q[64],q[65];
rz(1.748262914136678) q[64];
sx q[64];
rz(-1.5711744734616016) q[64];
sx q[64];
rz(-0.47675037702326906) q[64];
cx q[54],q[64];
cx q[64],q[63];
cx q[63],q[64];
sx q[64];
...
rz(pi/2) q[64];
sx q[65];
rz(-0.3499967187344737) q[65];
sx q[65];
rz(pi/2) q[65];
sx q[66];
rz(pi/2) q[66];
sx q[73];
rz(0.2673141479915979) q[73];
sx q[73];
...
cx q[54],q[64];
sx q[54];
rz(-1.1357731497354902) q[54];
sx q[54];
rz(0.2989926356969477) q[54];
sx q[63];
rz(2.567616643692407) q[63];
sx q[63];
rz(0.7934855547557511) q[63];
sx q[64];
...
rz(pi/2) q[65];
sx q[65];
rz(-1.7068093966568565) q[65];
sx q[65];
rz(-2.8469343886424587) q[65];
rz(-0.36746080322190977) q[66];
sx q[66];
rz(-1.899123326114947) q[66];
sx q[66];
rz(0.6178669067251379) q[66];
sx q[67];
rz(0.9449733637530091) q[67];
sx q[67];
rz(-1.2522384758651306) q[67];
cx q[67],q[66];
cx q[66],q[67];
cx q[67],q[66];
sx q[73];
...
cx q[64],q[65];
sx q[64];
rz(2.242156577265021) q[64];
sx q[64];
rz(-0.675258675386285) q[64];
cx q[54],q[64];
cx q[64],q[54];
cx q[54],q[64];
cx q[67],q[66];
...
sx q[66];
rz(-1.0963427134462442) q[66];
sx q[66];
rz(2.7913723796959724) q[66];
sx q[73];
rz(1.5999986339275987) q[73];
sx q[73];
rz(2.0175663513732243) q[73];
barrier q[63],q[54],q[64],q[73],q[65],q[67],q[66];
measure q[63] -> meas[0];
measure q[54] -> meas[1];
measure q[64] -> meas[2];
measure q[73] -> meas[3];
